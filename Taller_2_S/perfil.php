<!DOCTYPE html>
<?php session_start();
  /*AQUI VA A IR UN CODIGO QUE VA A TRAER TODAS LAS VENTAS, CONTARLAS Y ASIGNARLAS A CADA PRODUCTO HECTOR AYUDA PORFAVOR*/
 ?>
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <body>
    ...
    <?php
      ...
      $queryProductos="SELECT tallerdos.productos.id AS idP,tallerdos.productos.nombre AS nombreP, tallerdos.productos.precio AS precioP, tallerdos.productos.compras as comprasP, tallerdos.productos.imagen as imagenP FROM tallerdos.productos";
