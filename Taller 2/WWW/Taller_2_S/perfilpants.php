...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <body>
    ...
    <?php
      ...
      $queryProductos="SELECT tallerdos.productos.id AS idP,tallerdos.productos.nombre AS nombreP, tallerdos.productos.precio AS precioP, tallerdos.productos.compras as comprasP, tallerdos.productos.imagen as imagenP FROM tallerdos.productos WHERE tallerdos.productos.categoria = 2";
